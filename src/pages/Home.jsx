  ...
  return (
    ...
    <NavBar/>
      ...
      <div className='my-8 lg:mx-0 mx-6'>
        <p style={{ color: theme.color2}} className='lg:text-xl text-lg text-wrap text-stone-300 lg:text-center'>Unleash the power of AI to create captivating books in minutes.</p>
