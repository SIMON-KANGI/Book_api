...
function How() {
 ...
 <section style={{ backgroundColor: theme.bg2}}  className='shadow-lg my-4 p-8 max-w-7xl mx-auto'>
    ...
    <section className='flex flex-wrap lg:grid grid-cols-3'>
       <div style={{ backgroundColor: theme.bg2}}  className='py-2 px-8 shadow-lg  items-center justify-center mx-4 my-4 rounded-md'>
       ...
       <div style={{ backgroundColor: theme.bg2}} className='py-2 shadow-lg px-8 items-center mx-4 my-4'>
        <img src="paradox.png" alt="paradox" className='w-48 h-72 mx-auto' />
        <div className='my-4'>
       ...
       <div style={{ backgroundColor: theme.bg2}} className='py-2 shadow-lg lg:px-8 items-center mx-4 my-4'>
        <img src="paradox.png" alt="paradox" className='w-48 h-72 mx-auto' />
        <div className='my-4'>
